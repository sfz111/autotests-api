...
print("Create user json:", create_user_data)
...
print("login response json:", login_response_data)
...
print("Update user response status code:", update_user_response.status_code)
print("Update user response json:", update_user_data)
